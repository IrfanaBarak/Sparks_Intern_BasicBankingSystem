    ...
    <div class="container" style=" padding-top:200px;"  >
          <div class="row">
             <div class="col-sm offset-md-3 col-md-6">
                  <div class="panel panel-default" style="padding: 10px; color:white; background-color:maroon; border-radius: 20px;">
                ...
                <div class="modal-body" style= "background-color:#e4bfc2;">
                    ...
                    <div class="form-group row">
                       ...
                       <div class="form-group row2">
                          <button href="profile.php?user_id=$id" style= "background-color:maroon;" type="submit" id="submit" name="submit" class="btn btn-primary btn-md ml-auto">Transfer</button>  
