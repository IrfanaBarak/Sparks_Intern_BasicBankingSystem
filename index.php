...
.row> p{
    ...
    padding-left: 19vw;
    position: absolute;
    top: 0;bottom: 50;right: 35;left: 20;
    padding-top: 32vh;
    font-family: 'Cookie';
    font-size: 2.5vw;
}
.btn{
    color: #4c3b19 !important;
            ...
            <div class="collapse navbar-collapse" id="navbarcontent">
                <ul class="navbar-nav mt-5 pr-5">
                   <li class="nav-item active">
                       <a href="./index.php" class="nav-link" style= "background-color:#4c3b19;"><span class="fa fa-home fa-lg"></span> Home <span class="sr-only">(current)</span></a>
                   </li>
                   <li class="nav-item">
                       <a href="./users.php" class="nav-link" style= "background-color:#4c3b19;"><span class="fa fa-address-card fa-lg"> </span>Users</a>
                   </li>
                   <li class="nav-item">
                       <a href="./history.php" class="nav-link" style= "background-color:#4c3b19;"><span class="fa fa-info fa-lg"></span>Transaction History</a>
                   </li>
                </ul>
            </div>
        </nav>
  ...
  <div id="transModal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-md" role="content">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style= "background-color:#e4bfc2;" >
